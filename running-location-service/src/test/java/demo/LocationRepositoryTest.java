...
public class LocationRepositoryTest {
    ...
    public void saveLocation() {
        this.repository.save(new Location(new UnitInfo("star-runningId-1")));
        assertThat(this.repository.findByUnitInfoRunningId("star-runningId-1", new PageRequest(0, 1)).getContent()
            .get(0).getRunningId()).isEqualTo("star-runningId-1");
    }

    @Test
    public void queryByUnitInfoRunningId() {
        final String runningId = "star-runningId-2";
